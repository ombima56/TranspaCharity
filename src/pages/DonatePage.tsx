          ...
          <div className="container">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="text-gray-600 md:text-lg">
                Choose to make a general donation or support a specific cause .Your generosity creates real change.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="max-w-4xl mx-auto">
              <Tabs defaultValue="general" className="mb-8">
                <TabsList className="w-full grid grid-cols-2 gap-2">
                  <TabsTrigger
                    value="general"
                    className="text-lg py-2 px-4 border border-gray-500 rounded-md hover:bg-gray-100 data-[state=active]:bg-teal-500 data-[state=active]:text-white"
                  >
                    General Donation
                  </TabsTrigger>
                  <TabsTrigger
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      ...
                      <p className="text-gray-600 mb-4">
                        Your general donation helps us direct funds where
                        they're needed most. We allocate these resources to the
                        most urgent causes and operational costs that keep our
                        platform running.
                      </p>
                      <div className="bg-teal-50 border border-teal-100 rounded-lg p-4 mb-4">
                        ...
                        <ul className="text-gray-700 space-y-2">
                          <li className="flex items-start">
                            ...
                            Fund critical initiatives that might not receive
                            targeted support
                          </li>
                          <li className="flex items-start">
                            <svg
                            ...
                            Support our work to identify and vet high-impact
                          ...
                          <li className="flex items-start">
                            ...
                            Help us maintain transparency and accountability in
                        ...
                        <CardContent className="p-4">
                          <div className="flex items-center gap-3">
                            ...
                            <p className="text-sm text-gray-700">
                              100% of your donation goes directly to charitable
                              work. Our operational costs are covered by
                              separate funding.
                            </p>
                          </div>
                        </CardContent>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">
                  Beyond donating, there are many ways you can contribute to our
                  mission.
                </p>
              </div>
                  ...
                  <CardContent className="p-6">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 text-sm mb-4">
                        Share your time and skills to help our causes on the
                        ground.
                      </p>
                      <Button
                        variant="outline"
                ...
                <Card>
                  <CardContent className="p-6">
                    <div className="text-center">
                      ...
                      <p className="text-gray-600 text-sm mb-4">
                        Spread the word about our work through your social
                        networks.
                      </p>
                      <Button
                        variant="outline"
