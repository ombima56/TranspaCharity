...
const DonationForm = ({ causeId, causeTitle }: DonationFormProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Thank you for your donation! This is a demo, no actual donation was made.');
  };
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-2 gap-2 mb-2">
            {predefinedAmounts.map(amount => (
              <Button
                ...
                className={donationAmount === amount && !customAmount ? "bg-teal-500 text-white" : ""}
          ...
          <div className="relative">
            <Button
              type="button"
              variant="outline"
              className={`w-full justify-start ${customAmount ? "border-teal-500 text-teal-500" : ""}`}
